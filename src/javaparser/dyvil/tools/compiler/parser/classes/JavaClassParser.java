...
public final class JavaClassParser extends Parser implements ITypeConsumer
{
	...
	private static final int	POST_GENERICS	= EXTENDS | POST_EXTENDS;
	private static final int	POST_NAME		= GENERICS | POST_GENERICS;
	...
	public JavaClassParser(IDyvilHeader header)
	{
		this.classList = header;
		this.mode = MODIFIERS;
	}
	
	public JavaClassParser(IClassList classList, CodeClass theClass)
	{
	...
	public void parse(IParserManager pm, IToken token) throws SyntaxError
	{
		...
		if (this.isInMode(BODY))
		{
			if (type == Symbols.OPEN_CURLY_BRACKET)
			{
				...
				pm.pushParser(new JavaClassBodyParser(this.theClass, body));
				this.mode = BODY_END;
				return;
			}
